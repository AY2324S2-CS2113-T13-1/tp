...
- [Developer Guide](#developer-guide)
  ...
  - [Design \& implementation](#design--implementation)
    - [The Overall UML Diagram:](#the-overall-uml-diagram)
    - [The overall Sequence Diagram:](#the-overall-sequence-diagram)
    - [ProblemGenerator Component](#problemgenerator-component)
      - [Command Parsing](#command-parsing)
      - [Problem Generation](#problem-generation)
      - [Default Options](#default-options)
      - [Answer Calculation](#answer-calculation)
    - [Checker Component](#checker-component)
      - [How `Checker` Works:](#how-checker-works)
      - [Pseudo Code for Reference:](#pseudo-code-for-reference)
      - [Future Enhancements for `Checker.java`:](#future-enhancements-for-checkerjava)
    ...
    - [DIYProblemSet Component](#diyproblemset-component)
      - [Class Signature](#class-signature)
      - [Class Variables](#class-variables)
      - [Class Methods](#class-methods)
      - [Method Flow](#method-flow)
    - [Testcase Component](#testcase-component)
  ...
  - [Instructions for manual testing](#instructions-for-manual-testing)
    ...
    - [Generate ProblemSet](#generate-problemset)
