...
public class Ui {
    ...
    private static final String INPUT_INSTRUCTION =
            "Input Instructions:\n" +
                    ...
                    "2. [number]: Specify the number of problems to generate. Must be between 1 and 100.\n" +
                    "3. [maximum digit]: Set the maximum number of digits for the numbers in the problems. Must be between 1 and 9.\n" +
                    "4. [number of operands]: Determine the number of operands in each problem. Must be between 2 and 10.\n\n" +
                    "Example Command: generate -t + -n 10 -d 2 -l 2\n" +
                    "This will generate 10 problems using the + operator only. Each problem will have 2 operands, and the maximum number of digits for each operand is 2 (i.e., up to 99).";
    private static final String GEN_COMMAND =
            "Generate problem sets: \t" + "gen -t [type] -n [number] -d [maximum digits]";
    private static final String HELP_COMMAND =
            "Help Function: \n" +
                    "To get help on a specific command, type 'help' followed by the command name. Here are the available commands:\n" +
